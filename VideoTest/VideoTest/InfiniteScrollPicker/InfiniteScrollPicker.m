...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        buttonStore = [[NSMutableArray alloc] init];
...
- (void)initInfiniteScrollView
{
    ...
    if (_imageAry.count > 0)
    {
        ...
        {
            UITapGestureRecognizer *oneFingerTwoTaps =[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(doSomething)];
